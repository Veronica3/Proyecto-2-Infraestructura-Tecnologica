...
public class Politica_Recuperacion {
    ...
    public void Prepaginacion(){
        ...
        System.out.println("ID proceso pagina mapa "+ ""+" ID proceso buscado "+ ID_Proceso_Buscado);
        ...
        while(keySetIterator.hasNext()){
            ...
            while(Contador_ID_Pagina<2/*WorkingSet*/){
        ...
        Imprime.imprime_lista_marcos(Estructura_DTO.Memoria_Virtual);
