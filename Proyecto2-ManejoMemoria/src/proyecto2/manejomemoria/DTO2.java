...
public class DTO2 {
    ...
    private String Politica_Recuperacion;
    private String Politica_Ubicacion;
    private String Politica_Reemplazo;
    private String Politica_Limpieza;
    private String Tamaño_Conjunto;
    private String Ambito_Reemplazo;
    private String Control_Limpieza;
    ...
    //
    public void setContenidoDTO(String Politica_Recuperacion, String Politica_Ubicacion, String Politica_Reemplazo, String Politica_Limpieza, String Tamaño_Conjunto, String Ambito_Reemplazo, String Control_Limpieza,int Paginas_Por_Proceso, int Tamaño_Memoria, int Tamaño_Paginas) {
